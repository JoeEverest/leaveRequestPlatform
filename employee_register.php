...
if (isset($_GET['email'])) {
    ...
    header("Location: create_employee_account.php");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="formHolder">
        <form method="post">
            ...
            <input class="form-control" readonly type="email" value="<?php echo $emailReg; ?>" name="email" id="email" placeholder="Email Address">
